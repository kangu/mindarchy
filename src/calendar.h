...
namespace Calendar {
inline QFont textFont(const QString &text) {
    QFont base(mindarchyTextFamily()); base.setPixelSize(15);
...
inline qreal textScale(const QString &text) {
    const auto font=textFont(text);
