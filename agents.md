...
- Reserve `dev.py full` (real windows/focus changes) for release validation or explicit requests to diagnose native window behavior. Do not launch visible test replays unless requested.
